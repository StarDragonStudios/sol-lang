...
public final class SemanticAnalyzer {
    ...
    private static final ModuleName ISOLATED_MODULE_NAME =
        new ModuleName(
            List.of("<isolated>")
        );

    private static final SourceSpan PROGRAM_DIAGNOSTIC_SPAN =
        new SourceSpan(
            new SourcePosition(
                0,
                1,
    ...
    public static SemanticAnalysisResult analyze(
        CompilationUnit unit
    ) {
        Objects.requireNonNull(
            unit,
            "Compilation unit must not be null."
        );
    ...
    public static SemanticProgramAnalysisResult analyzeModules(
        List<SourceModule> sourceModules
    ) {
        Objects.requireNonNull(
            sourceModules,
            "Source modules must not be null."
        );
    ...
    public static SemanticProgramAnalysisResult analyzeProgram(
        List<SourceModule> sourceModules
    ) {
        Objects.requireNonNull(
            sourceModules,
    ...
    private static final class ProgramBinder {
        ...
        private final IdentityHashMap<
            TypeReference,
            TypeSymbol
        > programResolvedTypes =
            new IdentityHashMap<>();

        private final boolean requireEntryPoint;

        private ProgramBinder(
            List<SourceModule> sourceModules,
            ...
            for (
                ...
                modulesCopy.add(
                    Objects.requireNonNull(
                        sourceModule,
                        "Source modules must not contain null values."
                    )
                );
            }
        ...
        private SemanticProgramAnalysisResult bind() {
            binders.values().forEach(
                Binder::predeclareFunctions
            );

            binders.values().forEach(
                Binder::resolveInjections
            );

            binders.values().forEach(
                Binder::bindFunctionSignatures
            );
            ...
            return new SemanticProgramAnalysisResult(
                modules,
                analyses,
                entryPoint,
                programDiagnostics
        ...
        private Optional<ProgramEntryPoint>
        resolveEntryPoint(
            List<Diagnostic> programDiagnostics
        ) {
            var candidates =
                collectEntryPointCandidates();
        ...
        private List<EntryPointCandidate>
        collectEntryPointCandidates() {
            var candidates =
                new ArrayList<
                    EntryPointCandidate
    ...
    private record EntryPointCandidate(
        ...
        private EntryPointCandidate {
            Objects.requireNonNull(
                binder,
                "Entry point candidate binder must not be null."
            );

            Objects.requireNonNull(
                module,
                "Entry point candidate module must not be null."
            );

            Objects.requireNonNull(
                declaration,
                "Entry point candidate declaration must not be null."
            );

            Objects.requireNonNull(
                function,
                "Entry point candidate function must not be null."
            );

            Objects.requireNonNull(
                annotation,
                "Entry point candidate annotation must not be null."
            );
        }
    }
    ...
    private static final class Binder {
        ...
        private Binder(
            ...
            Objects.requireNonNull(
                sourceModule,
                "Source module must not be null."
            );

            this.module =
                Objects.requireNonNull(
                    module,
                    "Semantic module must not be null."
                );
            ...
            this.modules =
                Map.copyOf(
                    Objects.requireNonNull(
                        modules,
                        "Semantic module registry must not be null."
                    )
                );

            this.programResolvedTypes =
                Objects.requireNonNull(
                    programResolvedTypes,
                    "Program type associations must not be null."
                );
        ...
        validateEntryPointCandidate(
            ...
            var valid =
                !duplicateFunctions.containsKey(
                    function
                );
            ...
            if (function.body().isEmpty()) {
                diagnostics.add(
                    new Diagnostic(
                        ...
                        DiagnosticSeverity.ERROR,
                        "Entry point '%s' must have a function body."
                            .formatted(
                                function.name()
                            ),
                        function.span()
            ...
            if (
                ...
                diagnostics.add(
                    new Diagnostic(
                        ...
                        DiagnosticSeverity.ERROR,
                        "Entry point '%s' must return 'int', but returns '%s'."
                            .formatted(
                                function.name(),
                                returnType.name()
                            ),
        ...
        private void reportAdditionalEntryPoint(
            ...
            diagnostics.add(
                new Diagnostic(
                    ...
                    DiagnosticSeverity.ERROR,
                    "Function '%s' is an additional '@init' entry point; only one is allowed."
                        .formatted(
                            candidate.declaration()
                                .name()
                        ),
        ...
        private void bindFunctionSignature(
            FunctionDeclaration function
        ) {
            var functionSymbol =
                functionSymbols.get(
        ...
        private void bindFunctionBody(
            FunctionDeclaration function
        ) {
            function.body().ifPresent(
                body -> {
                    var functionScope =
                        functionScopes.get(
                            function
        ...
        private void bindVariableDeclaration(
        ...
        private TypeSymbol bindExpression(
            ...
            switch (expression) {
                ...
                case UnaryExpression unary -> {
                    ...
                    type =
                        OperatorTypeChecker.checkUnary(
                            unary,
                            operandType,
                            diagnostics
                        );
                ...
                case BinaryExpression binary -> {
                    ...
                    type =
                        OperatorTypeChecker.checkBinary(
                            binary,
                            leftType,
                            rightType,
                            diagnostics
        ...
        private TypeSymbol bindNameExpression(
        ...
        private TypeSymbol typeOfValueSymbol(
            Symbol symbol
        ) {
            if (
                symbol
        ...
        private TypeSymbol bindCallExpression(
            CallExpression call,
            Scope scope
        ) {
            var calleeType =
        ...
        private Optional<FunctionSymbol>
        resolvedFunctionOf(
            Expression expression
        ) {
            if (
        ...
        private TypeSymbol resolvedTypeOf(
            TypeReference reference
        ) {
            return programResolvedTypes
                .getOrDefault(
                    reference,
                    BuiltInTypes.ERROR
                );
        ...
        private void reportImmutableParameter(
            AssignmentStatement assignment,
            ParameterSymbol parameter
        ) {
            diagnostics.add(
        ...
        private void resolveInjections() {
            for (
                ...
                if (
                    declaration
                        instanceof
                        InjectionDeclaration injection
                ) {
                    resolveInjection(
                        injection
                    );
        ...
        private void resolveInjection(
            InjectionDeclaration injection
        ) {
            var targetName =
                new ModuleName(
                    injection.modulePath()
                        .segments()
                );
            ...
            switch (injection.kind()) {
                case DIRECT ->
                    resolveDirectInjection(
                        injection,
                        targetModule
                    );

                case NAMESPACE ->
                    resolveNamespaceInjection(
                        injection,
                        targetModule
                    );
            }
        ...
        private void resolveDirectInjection(
            InjectionDeclaration injection,
            ...
            directlyInjectedFunctions.put(
                injection,
                List.copyOf(injected)
            );
        }

        private void declareInjectedFunction(
            InjectionDeclaration injection,
            FunctionSymbol function,
            List<FunctionSymbol> injected
        ) {
            if (
                !moduleScope.declare(
                    function
        ...
        private void resolveNamespaceInjection(
            InjectionDeclaration injection,
            ModuleSymbol targetModule
        ) {
            var namespaceName =
            ...
            injectedNamespaces.put(
                injection,
                namespace
            );
        }

        private void reportInjectedDuplicate(
            String name,
            InjectionDeclaration injection
        ) {
            diagnostics.add(
